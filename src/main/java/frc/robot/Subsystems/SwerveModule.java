...
public class SwerveModule {
    ...
    private void resetTurnToAbsolute(){
        ...
        double canCodePosInRadians = canCoder.getAbsolutePosition().getValueAsDouble() * Conversions.twoPi;
...
//        turn.setPosition(-Conversions.radiansToFalcon(angle));
    ...
    public void periodic(){
        if (DebugSetting.TraceLevel == DebugLevel.Swerve || DebugSetting.TraceLevel == DebugLevel.All){
            ...
            SmartDashboard.putNumber(canCoderName,  Units.radiansToDegrees(canCoder.getAbsolutePosition().getValueAsDouble() * Conversions.twoPi - offset));
